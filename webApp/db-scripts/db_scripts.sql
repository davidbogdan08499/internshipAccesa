...
CREATE TABLE `users` (
  ...
  `confirmp` varchar(300) DEFAULT NULL,
...
INSERT INTO `users` VALUES (2,'admin','admin','admin','davidbogdan970@gmail.com',570,'CHAMPION');
...
-- Dump completed on 2023-04-12 10:06:46
